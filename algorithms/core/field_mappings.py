...
def build_field_mappings_ikp(ikp_type: str, bentuk_output: str, tahun: str, layer=None):
    """
    ...
    if layer is not None:
        ...
        base_fields = [
            ...
            if f["name"] not in ["WADMKC", "WADMKD"] or f["name"] in existing_fields
        ]
    ...
    if ikp_type.lower() == "kehati":
        if bentuk_output.lower() == "grid":
            ...
            extra_fields = [
                ...
                {"name": f"PGA_{YY}_KK", "type": 6, "expression": f"PGA_{YY}_KK"},
                {"name": f"PHK_{YY}_KK", "type": 6, "expression": f"PHK_{YY}_KK"},
            ...
            raise ValueError("bentuk_output must be 'grid' or 'poligon' for Kehati")
        ...
        if bentuk_output.lower() == "grid":
            ...
            extra_fields = [
                ...
                {"name": f"KPKU_{YY}", "type": 10, "expression": f"KPKU_{YY}"},
            ...
            raise ValueError("bentuk_output must be 'grid' or 'poligon' for Udara")
        ...
        raise ValueError("ikp_type must be one of 'kehati', 'udara', or 'lahan'")
