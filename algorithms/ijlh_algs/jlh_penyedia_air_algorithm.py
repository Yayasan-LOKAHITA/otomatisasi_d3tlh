...
class JLHPenyediaAir(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        def joinSkorMatra(source, matra): 
            ...
            match matra.lower():
                case 'kba':
                    skor_file_name = "skor_ekoregion_jlh_penyedia_air.csv"
                case 'kva':
                    skor_file_name = "skor_vegetasi_jlh_penyedia_air.csv"
                case 'pl':
                    skor_file_name = "skor_pl_jlh_penyedia_air.csv"

            csv_path_skor = f"{os.path.dirname(__file__)}/../../data/jlh_pa/{skor_file_name}"  # Update with the actual path to your CSV file
