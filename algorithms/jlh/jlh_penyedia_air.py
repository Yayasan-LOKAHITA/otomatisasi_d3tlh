...
class JLHWaterSupplyAlgorithm(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config):
        ...
        self.addParameter(
            QgsProcessingParameterFeatureSink(self.OUTPUT, self.tr("JLH Penyedia Air"))
        )
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        src_idx = processing.run(
            ...
            context=context,
            feedback=feedback.pushInfo("✅ Perhitungan JLH Penyedia Air berhasil"),
        )["OUTPUT"]
        ...
        if bentuk_output == "Poligon":
            ...
            if skor_jlh == "Kabupaten/Kota":
                ...
                out_src = processing.run("qgis:fieldcalculator", out_src_kk_grid)[
                    "OUTPUT"
                ]
