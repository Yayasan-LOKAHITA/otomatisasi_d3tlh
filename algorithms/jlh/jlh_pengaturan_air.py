...
class JLHWaterRegulationAlgorithm(QgsProcessingAlgorithm):
    ...
    def shortHelpString(self):
        return self.tr(
            "This algorithm calculates the Flood Regulation Ecosystem "
            "Service Index (IJLH_PGA), which represents an ecosystem's "
            "ability to regulate surface water flow, reduce runoff, and "
            ...
            "otomatisasi_d3tlh-docs/jlh/jlh_pga/'>here</a>.</b>"
        )
