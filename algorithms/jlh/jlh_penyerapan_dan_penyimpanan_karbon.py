...
class JLHCarbonStorageAlgorithm(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config):
        ...
        self.addParameter(
            QgsProcessingParameterFeatureSink(
                self.OUTPUT, self.tr("JLH Penyerapan dan Penyimpan Karbon")
            )
        )
    ...
    def processAlgorithm(self, parameters, context, feedback):
        ...
        def pl_filename(island_name: str) -> str:
            base = {
                "Jawa": "skor_pl_ppk.csv",
                "Sumatera": "skor_pl_ppk.csv",
                "Kalimantan": "skor_pl_ppk.csv",
                "Sulawesi": "skor_pl_ppk.csv",
                "Papua": "skor_pl_ppk.csv",
                "Bali–Nusra": "skor_pl_ppk.csv",
                "Maluku": "skor_pl_ppk.csv",
            }
    ...
    def icon(self):
        return QIcon(os.path.join(os.path.dirname(__file__), '03 Ecosystem Services.svg'))
        
    def shortHelpString(self):
        return self.tr(
            """
        <b>Indeks Jasa Lingkungan Hidup (IJLH) – Penyerapan dan Penyimpanan Karbon (JLH_PPK)</b><br>
        <i>Environmental Service Index – Carbon Sequestration and Storage (JLH_PPK)</i>

        <h3>🇮🇩 Deskripsi (Bahasa Indonesia)</h3>
        Algoritma ini digunakan untuk menghitung <b>Indeks Jasa Lingkungan Hidup Penyerapan dan Penyimpanan Karbon (JLH_PPK)</b> 
        yang menggambarkan kemampuan ekosistem dalam menyerap dan menyimpan karbon dari atmosfer. 
        Pengembangan metode ini mengacu pada <b>Dokumen Petunjuk Teknis D3TLH 2024</b> dan disesuaikan dengan konteks spasial di Indonesia.

        <h4>🎯 Tujuan:</h4>
        Menilai kapasitas ekosistem dalam mendukung mitigasi perubahan iklim melalui:
        <ul>
        ...
        <h4>📤 Output:</h4>
        <ul>
            <li>Peta vektor hasil <b>Indeks JLH Penyerapan dan Penyimpanan Karbon (JLH_PPK)</b></li>
        </ul>

        <h4>⚙️ Metodologi:</h4>
        Nilai indeks dihitung melalui pendekatan <b>skoring dan pembobotan</b> antara parameter penutup lahan dan ekoregion.  
        Tutupan lahan dengan biomassa tinggi (misalnya hutan dan mangrove) memiliki skor lebih besar, 
        sedangkan ekoregion yang berperan penting dalam penyerapan karbon mendapat bobot tambahan.  
        Kombinasi keduanya menghasilkan indeks spasial yang menunjukkan potensi penyerapan dan penyimpanan karbon.
        ...
        This algorithm calculates the <b>Environmental Service Index – Carbon Sequestration and Storage (JLH_PPK)</b>, 
        representing the ecosystem’s ability to absorb and store atmospheric carbon.  
        The method follows the <b>D3TLH Technical Guideline 2024</b> and is adapted for Indonesia’s ecological and spatial conditions.

        <h4>🎯 Purpose:</h4>
        To assess the capacity of ecosystems to support climate change mitigation through:
        <ul>
        ...
        <h4>📤 Output:</h4>
        <ul>
            <li>Vector map of <b>JLH Carbon Sequestration and Storage Index (JLH_PPK)</b></li>
        </ul>

        <h4>⚙️ Methodology:</h4>
        The index is derived through a <b>scoring and weighting approach</b> between land cover and ecoregion parameters.  
        Land cover types with high biomass (e.g., forests, mangroves) receive higher scores, 
        while ecoregions critical for carbon storage are given additional weights.  
        The combined spatial index represents the ecosystem’s potential for carbon sequestration and storage.
