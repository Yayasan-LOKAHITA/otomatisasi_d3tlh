...
REQUIRED: A summary of the intentions with which the data set was developed.</abstract>
  ...
  <links>
    <link name="Shapefile" mimeType="" type="Local Area Network" format="" size="" url="file://\\USER-BD394F170D\C$\komounggulan\soi1jt.shp" description=""/>
  </links>
  <dates/>
  <fees></fees>
